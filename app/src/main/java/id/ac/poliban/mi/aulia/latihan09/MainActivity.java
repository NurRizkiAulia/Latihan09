package id.ac.poliban.mi.aulia.latihan09;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //default title di action bar "Latihan09"
        ...
        btImplicit.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/NurRizkiAulia"));
            startActivity(intent);
        });
    }
}
